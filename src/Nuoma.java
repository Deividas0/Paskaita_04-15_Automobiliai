...
public class Nuoma {
    ...
    public int nuomosSarasas() {
        ...
        System.out.println("5. Priskirti klientui kokį auto jis nuomavosi prieš tai.");
        System.out.println("6. Patikrinti kas dabar nuomuojasi automobilius.");
        switch (sc.nextInt()) {
            case 1:
            ...
            case 4:
                ...
                System.out.println(klientuSarasas.get(client - 1) + " Dabar nuomuojasi automobilį: " + klientuSarasas.get(client - 1).getDabarNuomuojasi());
                nuomosSarasas();
                break;
            case 5:
                String[] vardasPavarde2 = sc.nextLine().split(" ");                                                //bandymas
                klientas = new Klientas(vardasPavarde2[0], vardasPavarde2[1]);                                           //bandymas
                System.out.println("Pasirinkite klientą kuriam bus priskirtas ankščiau nuomuotas automobilis: ");
                ii = 1;
                for (Klientas a : klientuSarasas) {
                    System.out.println(ii + ". " + a);
                    ii++;
                ...
                int auto2 = sc.nextInt();
                klientuSarasas.get(client2 - 1).priskirtiPriesTaiNuomuotas(automobiliuSarasas.get(auto2 - 1));
                System.out.println(klientuSarasas.get(client2 - 1) + " Prieš tai nuomavosi: " + klientuSarasas.get(client2 - 1).getPriesTaiNuomotas());
                ANS.getAutoNuomosSarasas();
                nuomosSarasas();
                break;
            case 6:
                System.out.println("Sąrašas su dabar nuomuojamais automobiliais.");
                System.out.println();
